...
if(isset($_POST["catid"]) && !empty($_POST["catid"])){
    ...
    $stmt = $pdo->prepare("UPDATE category SET category=? WHERE catid=?");

    if(!$stmt->execute([ $category,$catid  ])) {
                ...
                <div class="col-lg-8 col-sm-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" name="category" maxlength="50"class="form-control" value="<?php echo $category; ?>">
