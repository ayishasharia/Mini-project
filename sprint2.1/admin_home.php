...
<head>
    ...
    <!-- Site Metas -->
    <title>Scratches - Ecommerce Bootstrap 4 HTML Template</title>
    ...
    <div class="categories-shop">
        ...
        <tr>
          <td><a href="addcat.php">Add Category</a></td>
		       ...
		       <tr>
          <td><a href="view_category.php">View/Modify Category</a></td>
		   </tr>
          ...
          <td><a href="addprod.php">Add Product</a></td>
		   ...
		   <tr>
          <td><a href="productview.php">View/Delete Product</a></td>
		  </tr>
					      <tr>
          <td><a href="userprofile.php">Customer View</a></td>
		  </tr>
