        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    ...
                    $orderBy = array('uid', 'Name', 'Username', 'Housename', 'Area', 'Pincode', 'District', 'Email', 'Phone');
                    $order = 'uid';
                    ...
                    if(!empty($_GET['search'])) {
                        ...
                        $sql = "SELECT * FROM registration
                            WHERE CONCAT_WS (uid,Name,Username,Housename,Area,Pincode,District,Email,Phone)
                            LIKE '%$search%'
                            ORDER BY $order $sort
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
										...
										echo "<th><a href=?search=$search&sort=&order=Housename&sort=$sort>Housename</th>";
										echo "<th><a href=?search=$search&sort=&order=Area&sort=$sort>Area</th>";
										echo "<th><a href=?search=$search&sort=&order=Pincode&sort=$sort>Pincode</th>";
										echo "<th><a href=?search=$search&sort=&order=District&sort=$sort>District</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . $row['uid'] . "</td>";echo "<td>" . $row['Name'] . "</td>";echo "<td>" . $row['Username'] . "</td>";echo "<td>" . $row['Housename'] . "</td>";echo "<td>" . $row['Area'] . "</td>";echo "<td>" . $row['Pincode'] . "</td>";echo "<td>" . $row['District'] . "</td>";echo "<td>" . $row['Email'] . "</td>";echo "<td>" . $row['Phone'] . "</td>";
