        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $orderBy = array('Order_id', 'Feedback');
                    $order = 'Feed_id';
                    ...
                    if(!empty($_GET['search'])) {
                        ...
                        $sql = "SELECT * FROM feedback
                            WHERE CONCAT_WS (Order_id,Feedback)
                            LIKE '%$search%'
                            ORDER BY $order $sort
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th><a href=?search=$search&sort=&order=Order_id&sort=$sort>Order_id</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
									$or_id= $row['Order_id'];
                                    echo "<tr>";
                                    echo "<td>" . $row['Order_id'] . "<br> <a href='order_tbl-index.php?search=".$or_id."'> Details</a></td>";echo "<td>" . $row['Feedback'] . "</td>";
                                        echo "<td>";
