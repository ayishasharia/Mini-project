...
if(isset($_POST['submit']))
{
	...
	// $sql="UPDATE product SET name = '$prod_name',image='$target_file',catid='$cat_name', price = '$prod_price', quantity= '$prod_qty', details = '$prod_details' WHERE id = '$prod_id'";
        $sql="UPDATE product1 SET name = '$prod_name',image='$target_file',image1='$target_file1',image2='$target_file2',catid='$cat_name', price = '$prod_price' WHERE pid = '$prod_id'";
	echo $sql;
...
if ($result->num_rows > 0) {
  ...
  echo "0 results";
    ...
    ?>
        ...
        <option value ="<?php echo $row['catid'] ?>"><?php echo $cname ?></option>";
	...
	?>
                ...
                <tr><td>Image </td><td><input name="prod_img1" type="file" class="form-control" ></td></tr>
                <tr><td>Image </td><td><input name="prod_img2" type="file" class="form-control" ></td></tr>
